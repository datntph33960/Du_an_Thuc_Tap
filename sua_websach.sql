...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 23, 2025 lúc 02:26 PM
...
INSERT INTO `carts` (`cart_id`, `product_id`, `user_id`, `product_name`, `product_price`, `product_quantity`, `product_image`, `product_size`, `product_color`) VALUES
...
(19, 'asdsd', 'default-product.jpg', 0);
...
INSERT INTO `orderdetails` (`orderdetails_id`, `order_id`, `product_id`, `quantity`, `price`, `size`, `color`) VALUES
(21, 10, 24, 1, 120000, '', ''),
(22, 10, 27, 1, 180000, '', ''),
(23, 11, 1, 2, 110000, '', ''),
(24, 11, 24, 1, 120000, '', ''),
...
(41, 8, '2023-12-12 17:53:39', 800000, 'Anh Khánh, Ninh Kiều, Cần Thơ', '0336246546', 'Gói hàng kĩ', 2),
...
(45, 6, '2023-12-13 15:12:18', 432000, 'Số 14 thành phố Rạch Giá, tỉnh Kiên Giang', '0336216546', 'Test mua hàng 13/12/2023', 3),
(52, 8, '2024-06-20 15:02:50', 758000, 'Cần Thơ', '0336216559', '', 3),
(53, 18, '2025-03-22 20:27:40', 440000, 'Lạng Sơn', '0348832396', '', 1),
(54, 18, '2025-03-22 20:28:06', 440000, 'Lạng Sơn', '0348832396', '', 1),
(55, 18, '2025-03-22 20:28:23', 440000, 'Lạng Sơn', '0348832396', '', 4);
...
(18, 6, 'Thần thoại', 'than-thoai.jpg', 66, 150000, 120000, '2023-11-20 23:20:33', 1, '<figure class=\"table\"><table><tbody><tr><td>Ngày</td><td>THÁNG</td></tr><tr><td>10</td><td>11</td></tr></tbody></table></figure>', '<ul><li>ngay sx: 20 /11/2003</li><li>name 20336</li></ul>', 1, '', ''),
...
(34, 4, 'Nguyễn Lê Anh Khoaassdasd', 'default-product.jpg', 2, 1235559999, NULL, '2024-06-07 18:20:15', 4, '', '<p>fssf</p>', 0, '', '');
...
(6, 'nguyenvana', '$2y$10$lkTB87KYB/DODbLsSsq7ZOfptwLQOuwXKpe8M9Y4pB5iPEh6k07f2', 'Nguyễn Văn A', 'user-default.png', 'nguyenvana@fpt.edu.vn', '0909135329', 'Ninh Kiều, Cần Thơ', 0, 1),
(7, 'khahi', '$2y$10$sF.yA6lAhvCE1vhwffwijuzA3JMoVhgnxkk.FdqXR4HVHlHdnXHzK', 'Nguyễn Văn B', 'user-default.png', 'nguyenvanb@fpt.edu.vn', '0336216654', 'Kiên Giang', 0, 1),
(8, 'admin', '$2y$10$zwNwMKly8otZrxWr6BTTxuRdX5eGj/2FbZT3wI3TfQ6Io8/jgAlLC', 'Phạm Dũng', 'user-default.png', 'phamdung101103@gmail.com', '0336216559', 'Cần Thơ', 1, 1),
...
(10, 'haohao', '$2y$10$gcBHpzElBGDkOv5EEzJFhuoireNk2HsaloJQLy2KHvzGqx6MIyYku', 'Nguyễn Văn c', 'user-default.png', 'nguyenvanc@fpt.edu.vn', '0909135985', 'Ninh Kiều, Cần Thơ', 0, 1),
(11, 'nguyenvanb', '$2y$10$9POq7/KNHwGwJg/YRpeI5OsRtE/hENkgsU6AL0rl3813dPueIXH/2', 'Nguyễn Văn E', 'user-default.png', 'nguyenvane@fpt.edu.vn', '0909006764', 'Cần Thơ', 1, 1),
(18, 'tiendatls65', '$2y$10$f0Ns96P.kWGrJbmd4xclxuSD5eWmxd.md8i/GLoO3NKMI8A34fEh6', 'nguyen tien dat', 'user-default.png', 'datntph33960@fpt.edu.vn', '0348832396', 'Lạng Sơn', 1, 1);
...
--
ALTER TABLE `carts`
  MODIFY `cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=182;
